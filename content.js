  ...
  voteShows: [
    ...
    },
    {
      ...
      guide: {
        ...
        rounds: [
          { label: "뮤빗 사전 투표", percent: "5%", app: "뮤빗", cost: "1표당 하트비트 3개", time: "방송 주 화요일 18:00 ~ 방송 주 목요일 11:00" },
        ...
        apps: [
          { name: "Mubeat(뮤빗)", currency: "하트비트", earnMethods: [
            "동영상 광고 시청: 광고 1회당 하트비트 3개, 하루 최대 광고 15회",
            "기타 충전 미션"
          ] },
          { name: "muniverse", currency: "골드루미, 애드루미", earnMethods: [
